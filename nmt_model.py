...
# LSTM input_size – The number of expected features in the input x
...
# LSTM CELL input_size – The number of expected features in the input x
...
# bias – If False, then the layer does not use bias weights b_ih and b_hh. Default: True
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        #get embedding source
        X = self.model_embeddings.source(source_padded)
        
        ##pad is fill with something and make sentense the same length       ##pack is packing some tensor into a matrix 
        
        #Packs a Tensor containing padded sequences of variable length. second tensor is list of sequences lengths of each batch element
        ...
        #Every RNN module take a PackedSequence as input.PackedSequence is an object and these second step is to build it.
        
        #`last_hidden` is a tensor shape (2, b, h),dim – the dimension over which the tensors are concatenated 1= cat on column
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        ###   Squeezing Returns a tensor with all the dimensions of input of size 1 removed.
        ###     Tensor Concatenation:
        ###         https://pytorch.org/docs/stable/torch.html#torch.cat
        ###     Tensor Stacking:
        ###         https://pytorch.org/docs/stable/torch.html#torch.stack

        #get att_project hidden
